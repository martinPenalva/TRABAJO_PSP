...
{
    private static readonly string Key = "YourSecretKey123!"; // En producción, usar una clave segura y almacenarla de forma segura
    private static readonly string IV = "YourIVKey1234567"; // En producción, usar un IV seguro
...
public class Reservation
{
    ...
    {
        get => EncryptionHelper.Decrypt(_customerName);
        set => _customerName = EncryptionHelper.Encrypt(value);
    }
